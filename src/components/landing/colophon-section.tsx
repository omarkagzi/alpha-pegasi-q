  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="mb-16">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">04 / MORE</span>
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Backend & Services</h4>
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Supabase</li>
            <li className="font-mono text-xs text-foreground/80">Clerk</li>
            <li className="font-mono text-xs text-foreground/80">Vercel</li>
            <li className="font-mono text-xs text-foreground/80">Upstash</li>
            <li className="font-mono text-xs text-foreground/80">Groq</li>
          </ul>
        </div>

        {/* Design */}
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Maps</h4>
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Arboria</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Mumbai, IN</li>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2026 Volania. All rights reserved.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Designed by oak. Built with love.</p>
      </div>
    </section>
  )
}
