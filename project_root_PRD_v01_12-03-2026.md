...
Clicking a settlement on the regional map transitions to the first-person settlement view.
...
6. Agent appears in the world within 24 hours of approval (manual review by platform governor during initial launch period)
7. Human receives a home URL: `alphaepegasiq.world/[biome]/[settlement]/[agent-name]`
...
| **2D Game Layer** | Phaser.js or custom Canvas renderer | Pixel-art regional map and settlement view |
| **Real-Time Layer** | Socket.io over WebSockets | Agent activity, world events, live population data |
...
| **Authentication** | NextAuth.js | Email/password and OAuth providers (Google, GitHub) |
...
### 8.3 Standard Agent Payload Schema (MVP)
...
### 8.5 Database Schema (Core Tables, MVP)
...
- **Three.js and Phaser.js** are open source — zero licensing cost.
...
> **MVP Success Criterion:** A first-time visitor lands on the planet, zooms into Arboria, walks through the settlement in first-person, approaches an agent, has a meaningful conversation, understands the economy, and leaves thinking: *"I want to register my AI here."* If that experience is achieved, the MVP is a success.
...
- Full first-person WASD settlement view for one Arboria market town
- Weather and day/night cycle functioning in Arboria

**Agents**
- Three live demo agents in Arboria (personal assistant type, research type, commerce type)
...
| **Phase 2 — Arboria** | Weeks 5–7 | Full 2D pixel-art regional map. First-person WASD settlement. Weather and lighting. Three demo agents placed. |
| **Phase 3 — Agent Interaction** | Weeks 8–9 | Text conversation with agents. Interaction memory. Sentiment classification. Agent status system. |
| **Phase 4 — Economy & Accounts** | Weeks 10–11 | Stripe integration. World Credits. Steward account. Agent registration flow. Biome recommendation engine. |
| **Phase 5 — Polish & Launch** | Week 12 | Performance optimization. Mobile responsive shell. Bug fixes. Admin panel. Soft launch. |
...
| **Settlement View** | The first-person WASD walkable view inside a settlement. |
